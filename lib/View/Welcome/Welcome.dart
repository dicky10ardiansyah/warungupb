...
import 'package:warungupb/View/Home/Home.dart';
import 'package:warungupb/View/Resturant/ResturantList.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child:Text("Warung UPB",style: TextStyle(color: primaryColor,fontSize: 30.0),),
            ),
            drawerMenu(),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 25.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("Batam, Nagoya",style: TextStyle(fontSize: titleText,color: secondryColor),),
                  SizedBox(height: 5.0,),
                  Text("Ubah",style: TextStyle(color: primaryColor,fontSize: normalText),),
                ],
              )
            ),
          ],
